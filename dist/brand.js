...
function NavyBar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      background: bg,
      color: H.text,
      padding: compact ? '17px 18px 17px' : wave ? '2px 18px 14px' : '12px 18px 10px',
      position: 'relative',
      overflow: 'hidden'
    }
...
function LocationFilterSheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u2713 ", userLocation.city && /*#__PURE__*/React.createElement("span", null, userLocation.city, " \xB7 "), t.active, " ", /*#__PURE__*/React.createElement("strong", null, radiusMiles, " ", t.miles)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 14
    ...
    d: "M21 12a9 9 0 1 1-2.33-6.17M21 3v6h-6"
  })), loading ? t.refreshing : t.refresh), /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--pg-aqua-300)'
    }
...
function RegionEditorSheet({
  ...
  }, lang === 'pt' ? 'Rotas Rápidas' : lang === 'es' ? 'Rutas Rápidas' : 'Quick Routes'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: 'var(--pg-ink-500)',
      marginTop: 1
