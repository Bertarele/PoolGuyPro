...
const SINGLE_POOLS = [{
  id: 1,
  name: {
    en: 'Coral Springs — residential house',
    pt: 'Coral Springs — casa residencial',
    es: 'Coral Springs — casa residencial'
  },
  revenue: {
    en: '$185/mo',
    pt: 'R$925/mês',
  ...
  type: 'house',
  desc: {
    en: '1-pool client, saltwater system. Client is already scheduled every Tuesday morning.',
    pt: '1 piscina, sistema de salto. Cliente já agendado toda terça de manhã.',
    es: '1 piscina, sistema de sal. Cliente ya programado cada martes por la mañana.'
  }
}, {
  id: 2,
  name: {
    en: 'Weston — condo pool + spa',
    pt: 'Weston — piscina de cond. + spa',
    es: 'Weston — piscina de cond. + spa'
  },
  revenue: {
    en: '$260/mo',
    pt: 'R$1.3k/mês',
  ...
  type: 'condo',
  desc: {
    en: 'Condo pool with attached spa. HOA pays directly, very reliable income.',
    pt: 'Piscina de condomínio com spa. Condomínio paga direto, renda confiável.',
    es: 'Piscina de condominio con spa. La HOA paga directamente, ingreso confiable.'
  }
}, {
  id: 3,
  name: {
    en: 'Pembroke Pines — 3 house pools',
    pt: 'Pembroke Pines — 3 piscinas residenciais',
    es: 'Pembroke Pines — 3 piscinas resid.'
  },
  revenue: {
    en: '$555/mo',
    pt: 'R$2.8k/mês',
  ...
  type: 'house',
  desc: {
    en: '3 houses in the same neighborhood, all on the same street. Very efficient route.',
    pt: '3 casas no mesmo bairro, na mesma rua. Rota muito eficiente.',
    es: '3 casas en el mismo barrio, en la misma calle. Ruta muy eficiente.'
  }
}, {
  id: 4,
  name: {
    en: 'Hollywood — vacation home',
    pt: 'Hollywood — casa de férias',
    es: 'Hollywood — casa de vacaciones'
  },
  revenue: {
    en: '$195/mo',
    pt: 'R$975/mês',
  ...
  type: 'house',
  desc: {
    en: 'Owner lives in New York. Pool service 4x/month, chemicals included in the price.',
    pt: 'Dono mora em New York. Serviço 4x/mês, químicos inclusos no preço.',
    es: 'El dueño vive en Nueva York. Servicio 4x/mes, químicos incluidos en el precio.'
  }
}, {
  id: 5,
  name: {
    en: 'Doral — 2 adjacent houses',
    pt: 'Doral — 2 casas vizinhas',
    es: 'Doral — 2 casas adyacentes'
  },
  revenue: {
    en: '$380/mo',
    pt: 'R$1.9k/mês',
  ...
  type: 'house',
  desc: {
    en: '2 side-by-side properties. Same owners, same service day. Ideal add-on to a nearby route.',
    pt: '2 propriedades lado a lado. Mesmos donos, mesmo dia de serviço. Ótimo complemento para rota próxima.',
    es: '2 propiedades contiguas. Mismos dueños, mismo día de servicio. Complemento ideal para ruta cercana.'
  }
}, {
  id: 6,
  name: {
    en: 'Plantation — 4-pool HOA cluster',
    pt: 'Plantation — cluster de 4 piscinas HOA',
    es: 'Plantation — 4 piscinas HOA'
  },
  revenue: {
    en: '$720/mo',
    pt: 'R$3.6k/mês',
  ...
  type: 'condo',
  desc: {
    en: '4-unit condo complex. One invoice, one visit per week. Association has a 2-year contract.',
    pt: 'Complexo com 4 unidades. Uma fatura, uma visita por semana. Associação tem contrato de 2 anos.',
    es: 'Complejo de 4 unidades. Una factura, una visita por semana. Asociación tiene contrato de 2 años.'
  }
}];
const QUICK_POOLS = [{
  id: 1,
...
const HIRING = [{
  ...
  perks: {
    en: ['Truck', 'Health', 'PTO'],
    pt: ['Veículo', 'Saúde', 'Férias'],
    es: ['Camioneta', 'Salud', 'Vacaciones']
  },
  rating: 4.8
}, {
  id: 2,
  ...
  role: {
    en: 'Senior Route Tech',
    pt: 'Técnico Sênior',
    es: 'Técnico Sénior de Ruta'
  },
  loc: 'Broward',
  pay: {
    en: '$36/hr',
  ...
  id: 3,
  company: 'Crystal Pool Co.',
  role: {
    en: 'Apprentice / Entry',
    pt: 'Aprendiz / Iniciante',
    es: 'Aprendiz / Inicial'
  },
  loc: 'Palm Beach',
  pay: {
...
// — vacation covers (shows in My Active Jobs) —
{
  id: 1,
  type: 'vacation',
  title: {
    en: 'May vacation cover — 5 pools',
    pt: 'Cobrir férias maio — 5 piscinas',
    es: 'Cobertura vacaciones mayo'
  },
  poster: 'Carlos N.',
  loc: 'Miami Beach',
  price: 275,
  ...
  type: 'vacation',
  title: {
    en: 'July vacation — 8 pools/day',
    pt: 'Férias julho — 8 piscinas/dia',
    es: 'Vacaciones julio'
  },
  poster: 'Patrícia L.',
  loc: 'Pinecrest',
...
// — hiring (full-time/part-time job positions) —
{
  id: 5,
  type: 'hiring',
  company: 'Aqua Solutions LLC',
  ...
  when: '6d',
  rejectReason: {
    en: 'The position was filled with an internal candidate. We will keep your résumé on file for future openings.',
    pt: 'A vaga foi preenchida por um candidato interno. Manteremos seu currículo para futuras oportunidades.',
    es: 'El puesto fue cubierto por un candidato interno. Guardaremos tu CV para futuras vacantes.'
  }
}, {
  id: 8,
  type: 'hiring',
  ...
  title: {
    en: 'Route Specialist',
    pt: 'Especialista de Rota',
    es: 'Especialista de Ruta'
  },
  loc: 'Coral Springs',
  pay: {
    en: '$30/hr + truck',
  ...
  startDate: {
    en: 'June 2, 2026',
    pt: '2 de junho de 2026',
    es: '2 de junio de 2026'
  },
  contact: {
    name: 'Mike Torres',
    phone: '(954) 382-1945',
    email: 'mike@premierpoolflorida.com'
  },
  perks: {
    en: ['Company truck', 'Health insurance', 'Paid time off', 'Tool allowance'],
    pt: ['Veículo da empresa', 'Plano de saúde', 'Férias pagas', 'Auxílio ferramentas'],
    es: ['Camioneta de empresa', 'Seguro médico', 'Vacaciones pagas', 'Subsidio herramientas']
  }
},
// — techs (applying to service technicians) —
{
  id: 9,
  type: 'techs',
  company: 'Rafael S.',
  title: {
    en: 'Pump & Motor Repair',
    pt: 'Reparo de Bomba e Motor',
    es: 'Reparación de Bomba y Motor'
  },
  loc: 'Miami',
  pay: {
    en: '$90/visit',
  ...
  when: '3h',
  note: {
    en: 'Confirmed for Wednesday 9am.',
    pt: 'Confirmado para quarta às 9h.',
    es: 'Confirmado para el miércoles a las 9am.'
  }
}, {
  id: 10,
  type: 'techs',
  company: 'Joana P.',
  title: {
    en: 'Heater Diagnostics',
    pt: 'Diagnóstico de Aquecedor',
    es: 'Diagnóstico de Calentador'
  },
  loc: 'Fort Lauderdale',
  pay: {
    en: '$75/visit',
  ...
  when: '12h',
  note: {
    en: 'Awaiting availability confirmation.',
    pt: 'Aguardando confirmação de disponibilidade.',
    es: 'Esperando confirmación de disponibilidad.'
  }
}];
