...
const STRINGS = {
  en: {
    ...
    title: 'Title',
    titlePh: 'Pool cleaning in Davie',
  ...
  pt: {
    ...
    priceNeg: 'Negociável',
    pricePerPool: 'Preço por piscina (USD)',
    typicalRange: '',
    summary: 'RESUMO',
    sumTitle: 'Título',
    sumPools: 'Piscinas',
...
const QUICK_POOL_SERVICE_TYPES = [{
  key: 'pump_repair',
  pt: 'Conserto de bomba',
  en: 'Pump repair'
}, {
  key: 'filter_wash',
  pt: 'Lavagem/troca de areia do filtro',
  en: 'Filter wash/backwash'
}, {
  key: 'vacuum',
  pt: 'Aspiração (vacuum)',
  en: 'Vacuum'
  ...
  key: 'leak_repair',
  pt: 'Reparo de vazamento',
  en: 'Leak repair'
}, {
  key: 'heater_repair',
  pt: 'Conserto de aquecedor',
  en: 'Heater repair'
}, {
  ...
  pt: 'Tratamento químico/choque',
  en: 'Chemical shock treatment'
}, {
  key: 'motor_replace',
  pt: 'Troca de motor',
  en: 'Motor replacement'
}, {
  key: 'automation',
  pt: 'Automação/timer',
  en: 'Automation/timer setup'
}, {
  key: 'tile_repair',
  pt: 'Reparo de azulejo/revestimento',
  en: 'Tile/surface repair'
}, {
  key: 'other',
  pt: 'Outro',
  en: 'Other'
