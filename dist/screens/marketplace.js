...
function MarketplaceScreen({
  ...
  if (isDesktop) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      }, countyFilter.length === 3 ? lang === 'pt' ? 'Sul da Flórida' : lang === 'es' ? 'Sur de Florida' : 'South FL' : countyFilter.map(c => c === 'Miami-Dade' ? 'Dade' : c).join(' · ')), /*#__PURE__*/React.createElement("svg", {
        width: "10",
        height: "10",
        viewBox: "0 0 24 24",
        fill: "none",
      ...
      id: 'pools',
      label: lang === 'pt' ? 'Piscinas avulsas (1–4)' : 'Individual Pools (1–4)'
    ...
    }, routeSub === 'pools' ? 'pools' : 'POOLS'))), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        padding: '16px 18px'
      }
    ...
    })), countyPickerOpen && /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'fixed',
        inset: 0,
        background: 'rgba(0,0,0,0.50)',
      ...
      onClick: () => setCountyPickerOpen(false)
    }, /*#__PURE__*/React.createElement("div", {
      onClick: e => e.stopPropagation(),
      style: {
        width: '100%',
    ...
    }, lang === 'pt' ? 'Selecione os condados para filtrar os anúncios' : lang === 'es' ? 'Seleccione los condados para filtrar' : 'Select counties to filter listings'), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexDirection: 'column',
        gap: 10
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, Icon.pin(12, H.cntyIc), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 12,
        fontWeight: 600,
        color: H.cntyTxt,
  ...
  }, lang === 'pt' ? 'Confirmar' : lang === 'es' ? 'Confirmar' : 'Confirm'))), pendingRatings.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      margin: '12px 18px 0',
      padding: '12px 14px',
      borderRadius: 14,
...
function PostRouteSheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    placeholder: t.routeNamePh
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(FormLabel, null, t.clientsLbl), /*#__PURE__*/React.createElement("input", {
    className: "pg-field",
    value: clients,
