...
function ProfileScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    user: user,
    lang: lang
  }), /*#__PURE__*/React.createElement(QuickPoolAppHistory, {
    user: user,
    lang: lang
  }), /*#__PURE__*/React.createElement(WorkJobHistory, {
    user: user,
    lang: lang
...
function QuickPoolAppHistory({
  ...
  React.useEffect(() => {
    ...
    window.sb.from('quick_pool_applications').select('id, created_at, status, job_id, job_company, job_role, job_loc, job_author_id, applicant_name, note').eq('applicant_id', user.uid).order('created_at', {
      ascending: false
    }).limit(30).then(({
      data
    }) => setApps(data || []));
  ...
  const statusBadge = status => {
    if (status === 'accepted') return {
      label: lang === 'pt' ? 'Aceito' : 'Accepted',
      bg: '#DCFCE7',
      color: '#15803D'
    };
    if (status === 'rejected') return {
      label: lang === 'pt' ? 'Recusado' : 'Rejected',
      bg: '#FEE2E2',
      color: '#DC2626'
    };
    if (status === 'withdrawn') return {
      label: lang === 'pt' ? 'Retirado' : 'Withdrawn',
      bg: '#F3F4F6',
      color: '#6B7280'
    };
    return {
  ...
  return /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, title), apps.length > 0 && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
      fontWeight: 700,
      color: 'var(--pg-ink-500)'
  ...
  }, emptyMsg) : /*#__PURE__*/React.createElement(React.Fragment, null, visible.map((a, idx) => {
    ...
    }, a.job_role || a.job_company || (lang === 'pt' ? 'Vaga de piscina' : 'Pool job')), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: 'var(--pg-ink-500)',
        marginTop: 1
      }
    }, a.job_loc || '', a.job_loc ? ' · ' : '', fmtDate(a.created_at))), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        fontWeight: 700,
        padding: '3px 8px',
  ...
  }), apps.length > 3 && /*#__PURE__*/React.createElement("button", {
  ...
  }, expanded ? lang === 'pt' ? 'Ver menos' : 'Show less' : lang === 'pt' ? `Ver todas (${apps.length})` : `View all (${apps.length})`))));
}
...
function WorkJobHistory({
  ...
  const fmtDate = iso => {
    ...
    return d.toLocaleDateString(lang === 'pt' ? 'pt-BR' : lang === 'es' ? 'es' : 'en-US', {
      month: 'short',
      day: 'numeric',
      year: 'numeric'
    });
  ...
  return /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("div", {
    ...
    }, job.loc && /*#__PURE__*/React.createElement("span", null, job.loc), job.loc && /*#__PURE__*/React.createElement("span", null, "\xB7"), /*#__PURE__*/React.createElement("span", null, payStr))), /*#__PURE__*/React.createElement("div", {
      style: {
        flexShrink: 0,
        textAlign: 'right'
      }
    ...
    }, lang === 'pt' ? 'ENCERRADA' : lang === 'es' ? 'CERRADA' : 'CLOSED'), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 10,
        color: 'var(--pg-ink-400)',
        marginTop: 3
      }
    }, fmtDate(job.hired_at))));
  }), jobs.length > 3 && /*#__PURE__*/React.createElement("button", {
    onClick: () => setExpanded(v => !v),
    style: {
      width: '100%',
      padding: '10px 14px',
  ...
  }, expanded ? lang === 'pt' ? 'Ver menos' : lang === 'es' ? 'Ver menos' : 'Show less' : lang === 'pt' ? `Ver todas (${jobs.length})` : lang === 'es' ? `Ver todas (${jobs.length})` : `View all (${jobs.length})`)));
}
