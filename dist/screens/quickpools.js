...
function QuickPoolsScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(NavyBar, {
    title: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h1", {
      style: {
        margin: 0,
        fontFamily: 'var(--pg-font-display)',
        fontSize: 22,
    ...
    }, t.quickPools), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11.5,
        opacity: 0.75,
        marginTop: 3
    ...
    right: /*#__PURE__*/React.createElement("div", {
      ...
      dark: true,
      onClick: () => openChat && openChat()
    }, Icon.msg(20, '#fff')), hasUnreadChat && /*#__PURE__*/React.createElement("span", {
      style: {
        position: 'absolute',
        top: 5,
        right: 5,
      ...
      dark: true,
      onClick: () => openNotifications && openNotifications()
    }, Icon.bell(20, '#fff')), hasUnreadNotif && /*#__PURE__*/React.createElement("span", {
      style: {
        position: 'absolute',
        top: 5,
        right: 5,
  ...
  }, Icon.bell(11, 'rgba(255,255,255,0.85)'), lang === 'pt' ? 'NOTIFIC. POR DIA' : lang === 'es' ? 'NOTIF. POR DÍA' : 'NOTIF. BY DAY'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12.5,
      fontWeight: 600,
      marginTop: 3,
  ...
  }, notifCities.length > 0 ? notifCities.slice(0, 3).join(' · ') + (notifCities.length > 3 ? ` +${notifCities.length - 3}` : '') : lang === 'pt' ? 'Nenhuma cidade configurada' : 'No cities set'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      opacity: 0.6,
      marginTop: 2
    }
  }, activeDayCount, "/7 ", lang === 'pt' ? 'dias ativos' : 'days active')), /*#__PURE__*/React.createElement("button", {
    onClick: openRegionEditor,
    style: {
      border: '0.5px solid rgba(52,205,216,0.55)',
      background: 'rgba(14,186,199,0.28)',
      color: '#fff',
      height: 30,
      padding: '0 12px',
      borderRadius: 8,
  ...
  }, Icon.cal(13, '#fff'), " ", t.edit))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '14px 18px 0'
    }
  }, /*#__PURE__*/React.createElement(LeafletMapBlock, {
