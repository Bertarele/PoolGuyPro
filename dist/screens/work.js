...
function WorkScreen({
  ...
  const submitVacPaymentDispute = async (reasonId, description, evidenceUrls = []) => {
    ...
    try {
      if (window.sb && ctxUser?.uid && app.author_id) {
        ...
        if (error && !dup) showToast && showToast('❌ ' + (error.message || 'Error'));else showToast && showToast(dup ? lang === 'pt' ? '⚠ Você já tem um problema reportado nessa cobertura.' : lang === 'es' ? '⚠ Ya reportaste un problema en esta cobertura.' : '⚠ You already have an open report on this coverage.' : lang === 'pt' ? '✅ Problema reportado.' : lang === 'es' ? '✅ Problema reportado.' : '✅ Problem reported.');
      }
    } catch (e) {
  ...
  const handoffCardsList = sub === 'hiring' && liveHandoffs.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
    ...
    const deleteHandoffFromCard = async e => {
      ...
      const {
        error
      } = await window.sb.from('pool_handoffs').delete().eq('id', h._id);
      if (error) {
    ...
    return /*#__PURE__*/React.createElement("article", {
    ...
    }, canManageHere && /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        top: 10,
        right: 10,
      ...
      style: {
        ...
        gap: 10,
        marginBottom: 8,
        paddingRight: canManageHere ? 68 : 0
      }
    ...
    }, Icon.pool ? Icon.pool(15, '#D97706') : null), /*#__PURE__*/React.createElement("h3", {
      style: {
        margin: 0,
    ...
    }, (h.cities || []).join(' · ')), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 9.5,
        fontWeight: 700,
        padding: '2px 8px',
    ...
    }, Icon.cal(13, 'var(--pg-ink-500)'), " ", h.daysOfWeek.map(d => dayLbls[d] || d).join(', ')), /*#__PURE__*/React.createElement("span", null, h.poolsCount, " ", h.poolsCount > 1 ? lang === 'pt' ? 'piscinas' : lang === 'es' ? 'piscinas' : 'pools' : lang === 'pt' ? 'piscina' : lang === 'es' ? 'piscina' : 'pool')), /*#__PURE__*/React.createElement("div", {
  ...
  const handoffOverlays = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Sheet, {
    open: postPickerOpen,
  ...
  }, editingHandoff && /*#__PURE__*/React.createElement(PostPoolHandoffSheet, {
    lang: lang,
    initialValues: editingHandoff,
    onClose: () => setEditingHandoff(null),
    onSubmit: async data => {
      if (!data || !window.sb) {
  ...
  const vacPaymentGateOverlay = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(YesNoLaterGate, {
    open: !!vacPayGateApp,
    ...
    lang: lang,
    onYes: () => {
      const a = vacPayGateApp;
      setVacPayGateApp(null);
      openVacRating(a);
    },
    onLater: () => {
      const a = vacPayGateApp;
    ...
    onClose: () => {
      const a = vacPayReportApp;
      setVacPayReportApp(null);
      if (a) openVacRating(a);
    },
    lang: lang
  }));
  ...
  const myLiveVacApps = liveApplications.filter(a => liveVacations.some(v => v._id === a.job_id)).map(a => {
    ...
    return {
      ...
      title: relatedVac ? {
        en: 'Route coverage',
        pt: 'Cobertura de rota',
        es: 'Cobertura de ruta'
      } : {
        en: '',
        pt: '',
        es: ''
  ...
  if (isDesktop) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        onClick: () => {
          if (!app.canDoJobToday) {
            showToast && showToast(lang === 'pt' ? `🔒 Disponível em ${app.earliestDate.getDate()}/${app.earliestDate.getMonth() + 1}` : lang === 'es' ? `🔒 Disponible el ${app.earliestDate.getDate()}/${app.earliestDate.getMonth() + 1}` : `🔒 Available on ${app.earliestDate.getMonth() + 1}/${app.earliestDate.getDate()}`);
            return;
          }
      ...
      }, app.canDoJobToday ? lang === 'pt' ? 'Fazer serviço' : lang === 'es' ? 'Hacer el trabajo' : 'Do the job' : lang === 'pt' ? '🔒 Bloqueado' : lang === 'es' ? '🔒 Bloqueado' : '🔒 Locked') : isDone ? /*#__PURE__*/React.createElement("button", {
        onClick: () => setVacPayGateApp(app),
        style: {
          flexShrink: 0,
          height: 26,
          padding: '0 9px',
    ...
    }, handoffCardsList, sub === 'hiring' && /*#__PURE__*/React.createElement(HiringPanel, {
      t: t,
      lang: lang,
      onChat: openChat,
      ...
      lang: lang
    }), handoffOverlays, vacCompleteOverlay, vacPaymentGateOverlay);
  }
  // ── END desktop ────────────────────────────────────────────────
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    highlightVacId: ctx.pendingVacId,
    onHighlightConsumed: () => ctx.clearPendingVac && ctx.clearPendingVac()
  }))), FabBtn, handoffOverlays, vacCompleteOverlay, vacPaymentGateOverlay);
}
function HandoffDetailPanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    disabled: busy,
    title: lang === 'pt' ? 'Excluir' : lang === 'es' ? 'Eliminar' : 'Delete',
    style: {
      width: 32,
      height: 32,
      borderRadius: 9,
...
function HiringPanel({
  ...
  }, lang === 'pt' ? 'Ver perfil →' : lang === 'es' ? 'Ver perfil →' : 'View profile →')), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      fontSize: 13,
      lineHeight: 1.45,
...
function TechsPanel({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("article", {
      ...
      onClick: () => isOwner ? setEditingTech(tech) : openPublicProfile && openPublicProfile({
        name: tech.name,
        photo: tech.photoUrl,
        loc: tech.loc,
        uid: tech.author_id
  ...
  }, editingTech && /*#__PURE__*/React.createElement(PostTechSheet, {
    lang: lang,
    user: user,
    initialValues: {
    ...
    onSubmit: async data => {
      ...
      const {
        error
      } = await window.sb.from('techs').update({
...
function PostVacationSheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        alignItems: 'center',
        justifyContent: 'center',
        background: isPastDay ? 'transparent' : on ? 'var(--pg-blue-500)' : isToday ? 'var(--pg-blue-50)' : 'transparent',
        color: isPastDay ? 'var(--pg-ink-200)' : on ? '#fff' : isToday ? 'var(--pg-blue-600)' : 'var(--pg-ink-800)',
  ...
  }, Icon.shield(13, 'var(--pg-blue-700)'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11.5,
      color: 'var(--pg-blue-700)',
      fontWeight: 500,
  ...
  }, lang === 'pt' ? 'O endereço exato das piscinas só é revelado ao pool guy depois que a candidatura dele for aprovada por você.' : lang === 'es' ? 'La dirección exacta de las piscinas solo se revela al pool guy después de que apruebes su solicitud.' : "The exact pool address is only revealed to the pool guy once you approve their application.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
...
function WeekdayRegionRow({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      border: '1px solid var(--pg-ink-200)',
      background: showAddrs ? 'var(--pg-blue-500)' : 'var(--pg-ink-100)',
      height: 26,
      padding: '0 10px',
      borderRadius: 7,
      fontSize: 11.5,
