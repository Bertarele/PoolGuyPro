...
function HiringPanel({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    d: "M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"
  })), lang === 'pt' ? 'Excluir' : lang === 'es' ? 'Eliminar' : 'Delete')))), !hidePosted && (() => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, sectionLbl), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 11,
        fontWeight: 700,
        padding: '2px 8px',
      ...
      }, "\uD83D\uDCC5 ", withInterview, " ", lang === 'pt' ? 'entrevista' : lang === 'es' ? 'entrevista' : 'interview', withInterview > 1 ? 's' : ''))), /*#__PURE__*/React.createElement("div", {
        style: {
          display: 'flex',
          alignItems: 'center',
          gap: 5,
      ...
      }, post.applicants.length, " ", lang === 'pt' ? 'cands.' : lang === 'es' ? 'cands.' : 'apps'), Icon.chev(14, 'var(--pg-ink-300)'))));
    })));
  })());
}
