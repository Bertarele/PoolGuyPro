                  ...
                  <button key={item._id} onClick={()=>{
                    ...
                    <div style={{
                      ...
                      {item.photoUrl
                        ...
                        : <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--pg-blue-300)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="4"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
                      }
                    </div>
                    {/* Status + type badge */}
