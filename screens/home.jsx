        ...
        return (
          <div style={{background:_bg, position:'relative', overflow:'hidden', paddingBottom:16}}>
            ...
            <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0px 18px 0', position:'relative', zIndex:1, marginTop:-18}}>
              <div style={{height:118, overflow:'hidden', transform:'translateY(-23px) translateX(-14px)'}}>
      ...
      <div style={{padding:'16px 18px 16px', display:'flex', flexDirection:'column', gap:18}}>
        ...
        {!isPremium && (
          <button onClick={openPaywall} className="pg-press" style={{
            ...
            padding:0, borderRadius:18, overflow:'hidden', width:'100%',
            ...
            <div style={{position:'relative', padding:'18px 18px 16px', display:'flex', gap:14, alignItems:'flex-start'}}>
              {/* Icon */}
              <div style={{
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="rgba(14,186,199,1)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div style={{flex:1, minWidth:0}}>
                ...
                <div style={{
                  ...
                  <div style={{width:5, height:5, borderRadius:'50%', background:'#0EC8D8'}}/>
                  <span style={{fontSize:10, fontWeight:800, color:'#0EC8D8', letterSpacing:'0.08em'}}>{premiumLbls.tag.toUpperCase()}</span>
                </div>

                <h3 style={{margin:'0 0 5px', fontFamily:'var(--pg-font-display)', fontSize:20, fontWeight:800, color:'#fff', letterSpacing:'-0.02em', lineHeight:1.15}}>
                  {premiumLbls.be}
                </h3>
                <p style={{margin:'0 0 12px', fontSize:12.5, color:'rgba(255,255,255,0.72)', lineHeight:1.45}}>
                  {premiumLbls.desc}
                </p>
                ...
                <div style={{display:'flex', gap:6, flexWrap:'wrap', marginBottom:14}}>
                  {(lang==='pt'
                    ...
                    <span key={feat} style={{
                      ...
                      <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="rgba(14,186,199,0.90)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                      {feat}
                    </span>
                  ))}
                </div>
