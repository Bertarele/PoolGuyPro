      ...
      <div style={{width:'100%', height:'100%', position:'relative', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
        ...
        <div style={{
          ...
          <div style={{textAlign:'center', marginBottom:28}}>
            <img src="pgx-logo.png" alt="PoolGuyX" style={{height:260, width:'auto', filter:'drop-shadow(0 4px 16px rgba(0,0,0,0.18))'}}/>
            <div style={{fontSize:11, fontWeight:600, color:'#64748b', letterSpacing:'0.07em', textTransform:'uppercase', marginTop:12}}>{t.tagline}</div>
          </div>
