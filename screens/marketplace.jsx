          ...
          return (
            <div style={{background:_bg, padding:'28px 40px 56px', position:'relative', overflow:'visible'}}>
              ...
              <div style={{position:'absolute', inset:0, overflow:'hidden', pointerEvents:'none', zIndex:0}}>
                <img src="icone.png" alt="" style={{position:'absolute', left:'50%', top:'50%', transform:'translate(-50%,-50%)', height:320, objectFit:'contain', opacity:0.60, userSelect:'none'}}/>
              </div>
              ...
              <div style={{display:'flex', alignItems:'center', gap:20}}>
                ...
                <div style={{display:'flex', alignItems:'center', gap:8, flexShrink:0}}>
                  <button onClick={()=>setCountyPickerOpen(true)} style={{display:'flex', alignItems:'center', gap:6,
