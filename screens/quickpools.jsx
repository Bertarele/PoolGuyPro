      ...
      {(()=>{
        ...
        return (
          <NavyBar
            ...
            title={
              <div style={{display:'flex', alignItems:'center', gap:10}}>
                ...
                <div style={{paddingTop:2}}>
                  <div style={{fontSize:10.5, fontWeight:600, color:H.sub, letterSpacing:'0.10em', marginBottom:3, marginTop:-6, textTransform:'uppercase', whiteSpace:'nowrap'}}>
            ...
            right={
              <div style={{display:'flex', gap:6, alignItems:'center', transform:'translateY(9px)'}}>
